...
Item {
  ...
  Loader { readonly property var wall: block; sourceComponent: wall ? wallComponent : null; y: -renderTarget.wallHeight }
  Loader { readonly property var wall: vwall; sourceComponent: wall ? wallComponent : null; y: -renderTarget.wallHeight }
  Loader { readonly property var wall: hwall; sourceComponent: wall ? wallComponent : null; y: -renderTarget.wallHeight }
