...
void GameManager::startNewGame()
{
  if (!currentGame)
  {
    ...
    // TODO figure out what I meant by "initialize other factions"
    currentGame->getUniqueCharacterStorage()->load(currentGame->getDataEngine()->getUniqueCharacterStorage());
