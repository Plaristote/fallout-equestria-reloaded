...
public:
  ...
  QVector<DynamicObject*> getDynamicObjectsAt(Point position) const;
  ...
  Q_INVOKABLE QPoint      getClosestPosition(const TileZone* zone, QPoint) const;
  Q_INVOKABLE int         getVisionQuality(int ax, int ay, int bx, int by) const;
  Q_INVOKABLE QJSValue    getCharactersBetween(int ax, int ay, int bx, int by, unsigned int floor = NULL_FLOOR) const;
